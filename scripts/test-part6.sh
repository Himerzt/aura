...
check "frontend/app/onboarding/page.tsx" "onboarding_completed" "onboarding reads profile state"
check "frontend/app/onboarding/page.tsx" "Mọi thứ vẫn vậy"    "onboarding offers keep-or-update CTAs"
check "frontend/app/onboarding/page.tsx" "Cập nhật hồ sơ"      "onboarding shows review mode for returning users"
check "frontend/app/onboarding/page.tsx" "startEditing"        "onboarding prefills answers in editing mode"
...
echo "  - [ ] /onboarding (first-time) completes → 'Đang lưu...' → redirects to /morning"
echo "  - [ ] Revisiting /onboarding after completion → ReviewCard with current data + 2 CTAs"
echo "  - [ ] 'Mọi thứ vẫn vậy' button → /morning"
echo "  - [ ] 'Cập nhật hồ sơ' button → chat flow with answers prefilled, can modify each"
echo "  - [ ] After update → 'Đã cập nhật hồ sơ' bubble → redirects to /morning"
